...
@Component({
  selector: 'app-value-list-ce',
  templateUrl: './value-list-ce.component.html',
  styleUrls: ['./value-list-ce.component.scss'],
})
export class ValueListCeComponent implements OnInit {
